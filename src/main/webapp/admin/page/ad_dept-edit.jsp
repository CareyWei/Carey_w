    ...
    <form id="doctor_info"   onsubmit="return false;" action="#" method="post" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
               ...
               readonly="readonly"    autocomplete="off" class="layui-input" value="${dT.dTid}" >
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="dTname" name="dTname" required="" lay-verify="dTname"
                       autocomplete="off" class="layui-input" value="${dT.dTname}">
            </div>
        </div>
            ...
            <div class="layui-input-inline">
                <select  name="did"  id="did">
                    ...
                    <c:forEach items="${dept}" var="s1" >
                        <option value="${s1.did}" ${dT.deptlist.did==s1.did?'selected':''}>${s1.dname}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
...
<script>
    ...
    function a_update(){
        ...
        $.ajax({//利用ajax发出请求
            type: "post",//请求类型
            url: "updateDept/", //向Controller里的batchDeleYyb传输ids
            data: {
                "dTid":dTid,
                "dTname":dTname,
                "did":did,
