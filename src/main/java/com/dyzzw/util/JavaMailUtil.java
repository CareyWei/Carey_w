...
public class JavaMailUtil {
    // 发件人的邮箱-修改为自己的
    public static String emailAccount = "805076150@qq.com";
    // 发件人邮箱授权码-修改为自己的
    public static String emailPassword = "zctytpekpzxjbegj";
    // 发件人邮箱服务地址-修改为自己的
     ...
     * To:发送
     */
    public static MimeMessage creatMimeMessage(Session session, String sendMail, String receiveMail, String html) throws MessagingException, IOException, UnsupportedEncodingException {
        // 1、创建一封邮件对象
